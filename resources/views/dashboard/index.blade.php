                            ...
                            <div class="grid grid-cols-3 gap-1 mt-2 text-center">
                                <div class="text-xs text-center rounded-lg m-1 p-1 shadow-lg bg-white max-w-xs">
                                    <span class="text-blue-600">
                                        <b>Unidade:</b> {{ $employee->nome_unidade }} 
                                    </span>
                                </div>

                                <div class="text-xs text-center rounded-lg m-1 p-1 shadow-lg bg-white max-w-xs">
                                    <span class="text-blue-600">
                                        <b>Referência:</b> {{ $employee->referencia }} 
                                    </span>
                                </div>
        
                                <div class="text-xs text-center rounded-lg p-1 m-1 shadow-lg bg-white max-w-xs">
                                    <span class="text-blue-600">
                                        <b>Detalhe:</b> {{ $employee->detalhe }} 
                                    </span>
                                </div>
                            </div>
                            <div class="grid grid-cols-1 gap-1 mt-2 text-center">
                                <div class="text-x rounded-lg p-2 shadow-lg @if ($employee->atu < $employee->min || $employee->atu > $employee->max || $employee->estaEmDegelo = false) bg-red-800 @else bg-blue-200 @endif">
