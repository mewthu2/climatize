          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <div>
                  ...
                  <x-input id="mac_sensor" class="mt-1 w-full" type="text" name="mac_sensor" :value="old('mac_sensor', $panel->mac_sensor)" required />
              </div>
              ...
              <div>
                  ...
                  <select id="atu" name="atu" class="mt-1 w-full form-select" required>
                      <option value="1" @if($panel->atu == '1') selected @endif>Sim</option>
                      <option value="0" @if($panel->atu == '0') selected @endif>Não</option>
                  </select>
              </div>
          </div>
