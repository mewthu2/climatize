                        ...
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md" style="background: #36384f !important;">
                                    <button type="button" style="background: #36384f !important;" class="inline-flex items-center px-1 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200  hover:text-white 1000 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
